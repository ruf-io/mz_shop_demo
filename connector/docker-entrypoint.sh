...
echo "${topics[@]}" | xargs -n1 -P8 kafka-topics --zookeeper zookeeper:2181 --bootstrap-server kafka:9092 --create --if-not-exists --partitions 1 --replication-factor 1 --topic
